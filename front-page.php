...
<div class="w-full m-0 docSlider font-sans">
    ...
    <section id="2" class="h-screen !overflow-x-hidden bg-black flex lg:flex-row flex-col-reverse items-center">
        <div class="lg:w-[35vw] w-full lg:h-full h-[47.5vh] md:h-[40vh] font-theme-heading font-normal text-white lg:ml-12 xl:ml-52 2xl:ml-52 xl:mr-12 lg:mr-8 lg:text-right text-center flex">
            <div class="m-auto">
                <h2 class="block text-2xl md:text-3xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-light p-2 lg:p-6 xl:p-2 px-4">The action behind the cameras</h2>
                <p class="block text-base lg:text-2xl xl:text-2xl 2xl:text-2xl font-light lg:p-6 xl:p-2 px-4">Service commitment and crew message ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
            </div>
        </div>
        <div class="lg:w-[65vw] w-full h-[52.5vh] md:h-[60vh] lg:h-full overflow-hidden">
            <div style="background-image: url('<?php echo get_theme_file_uri(); ?>/resources/img/GAS Family.jpg');" class="h-full bg-cover bg-center gas-mask mask-center image-mask md:-mt-[5vh] md:-mt-[10vh] lg:mt-0 lg:-mr-40 image-mask [-webkit-mask-size:175%!important] md:[-webkit-mask-size:125%!important] lg:[-webkit-mask-size:100%!important] [-webkit-mask-position:65%_100%!important] lg:[-webkit-mask-position:center!important]"></div>
        </div>
    </section>

    <section id="3" class="h-screen !overflow-x-hidden bg-white flex lg:flex-row flex-col">
        <div class="lg:w-[65vw] w-full lg:h-full h-[52.5vh] overflow-hidden">
            <div style="background-image: url('<?php echo get_theme_file_uri(); ?>/resources/img/studio.jpg');" class="h-full bg-cover bg-center gas-mask mask-center image-mask md:-mt-[11vh] lg:mt-0 lg:-ml-40 image-mask [-webkit-mask-size:175%!important] md:[-webkit-mask-size:125%!important] lg:[-webkit-mask-size:100%!important] [-webkit-mask-position:65%_100%!important] lg:[-webkit-mask-position:center!important]"></div>
        </div>
        <div class="lg:w-[35vw] w-full lg:h-full h-[47.5vh] md:h-[40vh] font-theme-heading font-normal text-black lg:mr-12 xl:mr-48 2xl:mr-48 lg:ml-8 lg:text-left text-center flex md:-mt-[5vh] lg:mt-0">
            <div class="m-auto text-left">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/studios-logo.png" class="w-auto max-h-[80px] 2xl:max-h-[120px] sm:-ml-1 2xl:-ml-2">
                <p class="block text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-light lg:py-2 xl:py-3 px-4">Service commitment and crew message ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex commodo.</p>
                <p class="block text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-normal lg:py-2 xl:py-3 px-4 text-center lg:text-left">Find out more <img src="<?php echo get_theme_file_uri(); ?>/resources/img/arrow-black.svg" class="-rotate-90 w-5 inline ml-4"></p>
            </div>
        </div>
    </section>
    ...
    <section id="4" class="h-screen !overflow-x-hidden bg-black flex flex-column text-white text-center font-theme-heading font-normal">
        <div style="background-image: url('<?php echo get_theme_file_uri(); ?>/resources/img/9E1585E1AAD72EB4.png');" class="absolute bg-[length:325%] bg-[30%_top] w-full h-[90vh] top-[10vh] overflow-hidden">
            <div class="sm:w-[75vw] md:w-[80vw] lg:w-[55vw] xl:w-[57.5vw] mx-auto font-light">
                ...
                <h2 class="text-2xl sm:text-3xl md:text-3xl lg:text-3xl 2xl:text-5xl sm:p-4 md:p-4 p-3 w-[65%] sm:w-[45%] mx-auto">Trust us, we've got it covered</h2>
                <p class="text-base sm:text-lg md:text-xl lg:text-xl 2xl:text-2xl p-2">Constantly evolving, ever-improving, it’s our job to prepare for changing tastes in photography, and adapt to whatever the industry needs. Across every part of our business, GAS guarantees that we’ll:</p>
                <p class="text-base sm:text-lg md:text-xl lg:text-xl 2xl:text-2xl sm:mt-3 md:mt-3 mt-2 p-2">Offer solutions to problems yet to happen,<br>Push ourselves to improve a client’s production,<br>Be professional but fun, always putting the job first,<br>Be brutally honest but totally fair,<br>Get it right whatever it takes.</p>
            </div>
        </div>
    </section>
    ...
    <section id="5" class="h-screen !overflow-x-hidden bg-black text-white max-w-full">
        <div class="flex flex-col h-full">
            ...
            <div class="sm:w-[90vw] md:w-[34vw] 2xl:w-[50vw] w-[90vw] sm:h-1/4 h-1/2 mx-auto font-theme-heading text-base sm:text-xl 2xl:text-3xl font-light text-center flex flex-col md:justify-around justify-end">
    ...
    <section id="6" class="h-screen !overflow-x-hidden">
        <div class="bg-[#3e3e3e] h-1/2">
            <p class="text-xl sm:text-2xl lg:text-3xl 2xl:text-3xl text-white text-center py-4 md:py-10 sm:py-4 absolute w-full block">Just a few of the brands we work with</p>
            <div class="owl-carousel h-full !flex flex-col justify-center pt-20">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/carousel-logos/Conde Nast Logo White.svg" class="item h-[25vh] md:h-[10vh] px-3 2xl:px-12">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/carousel-logos/Dazed Logo White.svg" class="item h-[25vh] md:h-[10vh] px-3 2xl:px-12">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/carousel-logos/Made Logo White.svg" class="item h-[25vh] md:h-[10vh] px-3 2xl:px-12">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/carousel-logos/Mulberry Logo White.svg" class="item h-[25vh] md:h-[10vh] px-3 2xl:px-12">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/carousel-logos/Vogue Logo White.svg" class="item h-[25vh] md:h-[10vh] px-3 2xl:px-12">
            </div>
        </div>
        <div class="bg-[#2f2f2f] h-1/2">
            <p class="text-xl sm:text-2xl lg:text-3xl 2xl:text-3xl text-white text-center py-4 md:py-10 sm:py-4 absolute w-full block">See what we're up to on Instagram</p>
            <div class="grid grid-cols-2 grid-rows-2 md:grid-cols-4 md:grid-rows-1 h-full items-center pt-[3rem]">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/ig-posts/post1.jpeg" class="max-h-full w-auto basis-[40%] mx-auto md:basis-[25%] p-[2.5vw]">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/ig-posts/post2.jpeg" class="max-h-full w-auto basis-[40%] mx-auto md:basis-[25%] p-[2.5vw]">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/ig-posts/post3.jpeg" class="max-h-full w-auto basis-[40%] mx-auto md:basis-[25%] p-[2.5vw]">
                <img src="<?php echo get_theme_file_uri(); ?>/resources/img/ig-posts/post4.jpeg" class="max-h-full w-auto basis-[40%] mx-auto md:basis-[25%] p-[2.5vw]">
            </div>
        </div>
        <div class="bg-black h-full md:h-1/2 flex flex-col justify-between">
            ...
            <div class="sm:grid sm:grid-cols-12 flex flex-col-reverse justify-between gap-4 text-white text-base sm:text-xl 2xl:text-2xl sm:mx-8 mx-4 font-light leading-6">
                ...
                <div class="md:col-start-8 md:col-end-13 col-span-12 md:col-span-5 flex flex-col justify-end">
                    ...
                    <div class="text-right text-white sm:mb-6 text-sm sm:text-base 2xl:text-2xl mt-4 hidden sm:block">Designed by <strong>SoreThumbStudio</strong>&reg;</div>
                </div>
            </div>
        </div>
    </section>
