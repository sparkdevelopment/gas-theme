<div class="min-h-screen bg-[#202020] relative">
	<form id="search-form" class="sticky top-0 w-full flex p-24 bg-black z-10">
	<div class="text-white z-10 absolute right-6 top-6">
		<div id="search-results-close" class="cursor-pointer">
			<svg class="w-8 h-8 nav-cross z-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<input id="search-input" type="text" class="flex-grow p-4 bg-[#202020] font-theme-heading text-4xl text-white placeholder:text-white" placeholder="Search">
