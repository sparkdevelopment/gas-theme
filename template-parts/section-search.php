<div class="min-h-screen bg-[#202020] relative">
	<form id="search-form" class="sticky top-0 w-full flex p-12 lg:p-24 bg-black z-10">
	<div class="text-white z-10 absolute right-3 lg:right-6 top-3 lg:top-6">
		<div id="search-results-close" class="cursor-pointer">
			<svg class="w-6 lg:w-8 h-6	 lg:h-8 nav-cross z-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
