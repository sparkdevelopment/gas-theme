...
searchInput.addEventListener('input', function (e) {
    ...
    fetch('/wp-json/wp/v2/product?search=' + searchTerm + '&_embed&per_page=96')
        ...
        .then(function (results) {
            ...
            searchResultsListItem.innerHTML =  '<a href="' + result.link + '" class="!mx-0 2xl:mt-0 2xl:translate-y-0 flex flex-col justify-center w-full h-[100vw] aspect-square sm:w-[50vw] md:w-[25vw] sm:h-[50vw] md:h-[25vw]"><div class="card-zoom"><div class="card-zoom-image" style="background-image: url(\'' + thubnailUrl + '\')"></div><h1 class="card-zoom-text !text-2xl md:!text-2xl 2xl:!text-4xl">' + result.title.rendered + '</h1></div>';
